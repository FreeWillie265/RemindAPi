            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    District = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Clerk = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Etc = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Traversed = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
